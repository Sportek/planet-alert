...
import { AlertTriangle, Earth, Leaf, TreePine } from "lucide-react";
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-teal-50 to-blue-50">
      ...
      <section className="relative h-screen flex items-center justify-center px-4">
        ...
        <div className="max-w-4xl text-center z-10 animate-fadeIn">
          ...
          {/* Nouveau paragraphe pour mettre en avant la carte interactive */}
          <p className="text-lg text-muted-foreground mb-8">
            Parcourez notre carte interactive des incidents pour visualiser en temps réel l'état de notre planète.
          </p>

          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Button
              onClick={() => navigate.push("/app/incident-form")}
            ...
            <Button
              onClick={() => navigate.push("/app/map")}
              className="button-gradient text-lg px-8 py-6"
            >
              Voir la carte interactive

              <Icon icon="mdi:map" className="ml-2" />
            </Button>
          </div>
